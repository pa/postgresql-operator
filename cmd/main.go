...
import (
	...
	"github.com/pa/postgresql-operator.git/internal/controller"
...
func init() {
	...
	utilruntime.Must(postgresqlpramodhayyappandevv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "57c1ac9d.pramodhayyappan.dev",
