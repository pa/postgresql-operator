...
# pramodhayyappan.dev/postgresql-operator-bundle:$VERSION and pramodhayyappan.dev/postgresql-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= pramodhayyappan.dev/postgresql-operator
